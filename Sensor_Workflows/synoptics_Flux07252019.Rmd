---
title: "Flux at Synoptic Points, get syn sites below waterfall from meg* NOT COMPLETE, only waterfall, 23,29,35 correct"
author: "Chloe"
date: "7/25/2019"
...
syn11 <- sub.2[19:22,]
syn14 <- sub.2[27:30,]
waterfall <- sub.2[1158:1161,]
#syn20 <- sub.2[44:47,]
syn23 <- sub.2[1169:1172,]
syn29 <- sub.2[1175:1178,]
syn35 <- sub.2[1180:1183,]
...
a <- data.frame(AverageFlux = c(syn1avg,syn5avg,syn8avg,syn11avg,syn14avg,waterfallavg,syn23avg,syn29avg,syn35avg))
rownames(a) <- c("syn1", "syn5", "syn8", "syn11", "syn14", "waterfall", "syn23", "syn29", "syn35")
kable(a, format = "markdown", row.names = TRUE)

avgplot <- ggplot(a)+
  geom_point(aes(x= 1:9, y= AverageFlux), color = "blue", size = 5) 
avgplot <- avgplot + scale_x_continuous(breaks=1:9, labels=c("syn1", "syn5", "syn8", "syn11", "syn14", "waterfall", "syn23", "syn29", "syn35")) +
