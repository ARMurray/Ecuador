...
July23avg <- data.frame("Day" = "July23", "Avg_iCO2" = mean(ecutogether$Delta_30s_iCO2), "StdDev_iCO2" = sd(ecutogether$Delta_30s_iCO2))
...
sumjuly23_30 <- rbind(col1avg, col2avg, col3avg, col4avg, col5avg, col6avg, col7avg, col8avg)

write.csv(sumjuly23_30, here("Picarro/EOSTransects/080119/", "sumjuly23_30sec_uncorrected.csv"))


#ok now let's do the correction 

sumjuly23_30$Correction <- as.numeric("0.112478047")
sumjuly23_30$CorrectedAverage <- as.numeric(c(sumjuly23_30$Avg_iCO2 + sumjuly23_30$Correction))

write.csv(sumjuly23_30, here("Picarro/EOSTransects/072219/", "sumjuly23_30sec_corrected.csv"))
