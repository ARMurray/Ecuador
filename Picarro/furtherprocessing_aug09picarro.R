...
sumaug09_30 <- rbind(col1avg, col2avg, col3avg, col4avg, col5avg, col6avg, col7avg, col8avg)

write.csv(sumaug09_30, here("Picarro/EOSTransects/080819/", "sumaug09_30sec_uncorrected.csv"))
