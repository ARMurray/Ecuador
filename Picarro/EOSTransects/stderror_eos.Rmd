...
#for percents 
onepercent_sample <- read.csv(here("Picarro/EOSTransects/oneperecenttest_samples.csv"))
day_onepercent <- read.csv(here("Picarro/EOSTransects/oneperecenttest_days.csv"))
```
