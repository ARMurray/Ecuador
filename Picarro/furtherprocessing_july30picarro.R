...
ecu1 <- alljuly30[ which(alljuly30$PosixCT > "2019-07-30 15:28:04"
...
sumjuly30ecu <- rbind(ecu2avg, ecu1avg)

write.csv(sumjuly30ecu, here("Picarro/EOSTransects/072919/", "sumecujuly30.csv"))
...
July30avg <- data.frame("Day" = "July30", "Avg_iCO2" = mean(ecutogether$Delta_30s_iCO2), "StdDev_iCO2" = sd(ecutogether$Delta_30s_iCO2))

write.csv(July30avg, here("Picarro/EOSTransects/072919/", "July30alldayecuavg.csv"))
...
col5testavg <- data.frame("Sample" = "col5test", "Avg_iCO2" = mean(col5test$Delta_30s_iCO2), "StdDev_iCO2" = sd(col5test$Delta_30s_iCO2))


sumjuly30_30 <- rbind(col1avg, col2avg, col3avg, col4avg, col5avg, col6avg, col7avg, col8avg, col5testavg)

write.csv(sumjuly30_30, here("Picarro/EOSTransects/072919/", "sumjuly30_30sec_uncorrected.csv"))


#ok now let's do the correction 

sumjuly30_30$Correction <- as.numeric("-0.003928632")
sumjuly30_30$CorrectedAverage <- as.numeric(c(sumjuly30_30$Avg_iCO2 + sumjuly30_30$Correction))

write.csv(sumjuly30_30, here("Picarro/EOSTransects/072919/", "sumjuly30_30sec_corrected.csv"))
