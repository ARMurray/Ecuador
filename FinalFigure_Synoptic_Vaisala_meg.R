...
dis <- data.frame(Distance = c(green,orange,yellow,darkblue,pink,blue)) 
dis <- formatC(dis$Distance,format="e")


plot <- ggplot(Synoptics) +
  geom_point(aes(x= Distance, y= Syn1_071819, color= dis$Distance[1]), size = 3)
+
