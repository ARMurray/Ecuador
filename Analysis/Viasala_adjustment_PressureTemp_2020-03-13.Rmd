...
stn1_check <- subset(temp.df.stn1,
                     Temp_c_Stn1Mean == 0 )
...
stn1 <- subset(stn1, DateTime > as.POSIXct('2019-07-09 12:15:00', tz='Etc/GMT+5') )


#stn1 <- subset(stn1, V1 != "NA" & Stn1_Pressure_hPa != "NA" & Temp_c_Stn1Mean != "NA")
stn1 <- stn1[rowSums(is.na(stn1[ , 2:4])) == 0, ]
stn1 <- stn1[complete.cases(stn1[ , 2:4]),]
