...
legendtitle <- list(yref='paper',xref="paper",y=.75,x=1.2, text="Discharge<br> [L/s<sup>-1</sup>]",showarrow=F)
...
CO2uMols13 <- filt13%>%
  ...
  tickangle = 325,
  tickfont = xaxisFont, tickformat = "%H:%M"),
    title = "&#916;CO<sub>2</sub> (Station 3-1 / Station 4-3) [&mu;mols/m<sup>2</sup>/s<sup>-1</sup>]",
         shapes = list(
               list(type = "rect",
                    fillcolor = "yellow", line = list(color = "yellow"), opacity = .2,
                    x0 = paste0(Sys.Date(), " 06:15"), x1 = paste0(Sys.Date(), " 18:21"), xref = "x",
                    y0 = -10, y1 = 65, yref = "y")),
  yaxis = list(title = "&#916;CO<sub>2</sub> [&mu;mols]",titlefont = labelFont,
  showticklabels = TRUE,
  tickangle = 0,
  tickfont = yaxisFont),
  showlegend=T)
    ...
    title = "&#916;CO<sub>2</sub> (Station 3-1 / Station 4-3) [&mu;mols/m<sup>2</sup>/s<sup>-1</sup>]",
         shapes = list(
               list(type = "rect",
                    ...
                    x0 = paste0(Sys.Date(), " 06:15"), x1 = paste0(Sys.Date(), " 18:21"), xref = "x",
                    y0 = -10, y1 = 65, yref = "y")),
  yaxis = list(title = "&Delta;CO<sub>2</sub> [&mu;mols]",titlefont = labelFont,
  showticklabels = TRUE,
  tickangle = 0,
  tickfont = yaxisFont),
  showlegend = T,
...
# Legend Title
legendtitle <- list(yref='paper',xref="paper",y=.62,x=1.08, text="<b>Station</b>",showarrow=F)
...
metabCO2%>%
  ...
  type = "date",
  tickformat = "%b %d"),
    yaxis = list(title = "CO<sub>2</sub> [&mu;mols m<sup>2</sup>d<sup>-1</sup>]", titlefont = labelFont,showticklabels = TRUE,
  tickangle = 0,
  tickfont = yaxisFont),
    legend = list (x = 1, y=.5),
    annotations = legendtitle
...
uplot <- up%>%
  ...
  tickformat = "%b %d",
  exponentformat = "E"),
    yaxis = list(title = "&mu;mols m<sup>2</sup>s<sup>-1</sup>", type = "log",titlefont = labelFont,
  showticklabels = TRUE,
  tickangle = 0,
  tickfont = yaxisFont),
  showlegend=F,
...
uplot <- up%>%
  ...
  tickformat = "%b %d",
  exponentformat = "E"),
    yaxis = list(title = "mols m<sup>2</sup>d<sup>-1</sup>", type = "",titlefont = labelFont,
  showticklabels = TRUE,
  tickangle = 0,
  tickfont = yaxisFont),
  showlegend=F,
...
uplot <- up%>%
  ...
  tickformat = "%b %d",
  exponentformat = "E"),
    yaxis = list(title = "mols m<sup>2</sup>d<sup>-1</sup>", type = "log",titlefont = labelFont,
  showticklabels = TRUE,
  tickangle = 0,
  tickfont = yaxisFont),
  showlegend=F,
