...
plot9 <- ggplot(c6time)+
  ...
  labs(x="", y=expression(Flux~('umol'/~m^2~s)))
...
grid.newpage()
grid.draw(rbind(ggplotGrob(plot11),ggplotGrob(plot7), ggplotGrob(plot9), ggplotGrob(plot2), 
                ggplotGrob(plot),ggplotGrob(plot3)))  
