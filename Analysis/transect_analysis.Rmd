...
col1.7 <- eos2[3832:3835,]
col2.7 <- eos2[3837:3840,]
col3.7 <- eos2[3842:3845,]
col4.7 <- eos2[3846:3849,]
col5.7 <- eos1[1344:1347,]
col6.7 <- eos1[1348:1351,]
col7.7 <- eos1[1352:1340,]
...
cplot <- ggplot() +
geom_point(data = c1, aes(x= z, y=c1), color = "red") + geom_point(data = c2, aes(x= z, y=c2), color = "orange")+ geom_point(data = c3, aes(x= z, y=c3), color = "yellow") + geom_point(data = c4, aes(x= z, y=c4), color = "green")+ geom_point(data = c5, aes(x= z, y=c5), color = "blue")+ geom_point(data = c6, aes(x= z, y=c6), color = "purple") +  geom_point(data = c7, aes(x= z, y=c7), color = "black")+ geom_point(data = c8, aes(x= z1, y=c8), color = "white")
cplot
```
...
```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}
cplot <- ggplot() +
  geom_line(data = c1, aes(x= z, y=c1, group = 1), color = "lightskyblue", size =2 ) + geom_line(data = c2, aes(x= z, y=c2, group = 1), color = "steelblue1", size =2 )+ geom_line(data = c3, aes(x= z, y=c3, group = 1), color = "dodgerblue3", size =2 ) + geom_line(data = c4, aes(x= z, y=c4, group = 1), color = "blue", size =2 )+ geom_line(data = c5, aes(x= z, y=c5, group = 1), color = "darkgreen", size =2 )+ geom_line(data = c6, aes(x= z, y=c6, group = 1), color = "olivedrab4", size =2 ) +  geom_line(data = c7, aes(x= z, y=c7, group = 1), color = "olivedrab3", size =2 )+ geom_line(data = c8, aes(x= z1, y=c8, group = 1), color = "darkolivegreen1", size =2 )
cplot
cplot <- ggplot() +
  geom_line(data = c1, aes(x= z, y=c1, group = 1), color = "brown", size =2 ) +   geom_line(data = c4, aes(x= z, y=c4, group = 1), color = "dodgerblue3", size =2 )+ geom_line(data = c5, aes(x= z, y=c5, group = 1), color = "blue", size =2 )+  geom_line(data = c8, aes(x= z1, y=c8, group = 1), color = "brown", size =2 )
cplot
```
...
landwater <- ggplot() + geom_line(data = land, aes(x= DateTime, y= Flux_eos2), color = "green", size = 1) +
  geom_line(data = water, aes(x=DateTime, y= Flux_eos1), color = "blue", size = 1)
