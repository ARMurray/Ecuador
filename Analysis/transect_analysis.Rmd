...
cplot
cplot <- ggplot() +
  geom_line(data = c1, aes(x= z, y=c1, group = 1), color = "red") + geom_line(data = c2, aes(x= z, y=c2, group = 1), color = "orange")+ geom_line(data = c3, aes(x= z, y=c3, group = 1), color = "yellow") + geom_line(data = c4, aes(x= z, y=c4, group = 1), color = "green")+ geom_line(data = c5, aes(x= z, y=c5, group = 1), color = "blue")+ geom_line(data = c6, aes(x= z, y=c6, group = 1), color = "purple") +  geom_line(data = c7, aes(x= z, y=c7, group = 1), color = "black")+ geom_line(data = c8, aes(x= z1, y=c8, group = 1), color = "white")
cplot
