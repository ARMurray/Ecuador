...
write.csv(pred1, here("Analysis/Stream_Metabolism/ModelOutputs/DO_1_Predictions.csv"))
write.csv(pred2, here("Analysis/Stream_Metabolism/ModelOutputs/DO_2_Predictions.csv"))
write.csv(pred4, here("Analysis/Stream_Metabolism/ModelOutputs/DO_4_Predictions.csv"))
