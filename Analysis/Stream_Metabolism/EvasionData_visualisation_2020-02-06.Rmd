...
#find the change in co2 concentration between station 1 and station 3
evasion.df$change_v1V3 <- evasion.df$V1 - evasion.df$V3
#find the change in co2 concentration between station 1 and station 2
evasion.df$change_v1V2 <- evasion.df$V1 - evasion.df$V2
#units on EOS = micromoles/m2/s2
#convert measurment of CO2 change between V1 and V3 ppm to micromoles
#eq 1  
  # [CO2]*discharge*distance btw viasala = flux
#1 mole of CO2 is 44.01g
#length of stream btw V1 and V3: 13m
#width of stream:  .5m
#stream surface area:
