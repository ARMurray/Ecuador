...
Synoptic flux paired with velocity 8-12-2019, 
peach points are velocities measured between each site, blue is velocity of synoptic sites found from interpolation, Purple is flux.

```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}

displot12 <- ggplot(c) + geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="purple") +   

  geom_point(aes(x= Distance, y= AverageFlux), color = "purple", size = 3) +   labs(x = "Synoptic Site Distance from Wetland (m) (8-12-2019)", y = "Average FLux (μmol/CO2/m2/s)") 

displot12 <- displot12 + geom_point(data = velocities, aes(Distance, y= aug12V), color = "tomato", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 12)) + geom_point(data = velocity, aes(distance, y= velocity), color = "blue", size = 3)
...
displot6 <- ggplot(c) + geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="purple") +   

  geom_point(aes(x= Distance, y= AverageFlux), color = "purple", size = 3) +   labs(x = "Synoptic Site Distance from Wetland (m) (8-6-2019)", y = "Average FLux (μmol/CO2/m2/s)") 

displot6 <- displot6 + geom_point(data = velocities, aes(Distance, y= aug6V), color = "tomato", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 11)) + geom_point(data = velocity, aes(distance, y= velocity), color = "blue", size = 3)
...
displot31 <- ggplot(c) + geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="purple") +   

  geom_point(aes(x= Distance, y= AverageFlux), color = "purple", size = 3) +   labs(x = "Synoptic Site Distance from Wetland (m) (7-31-2019)", y = "Average FLux (μmol/CO2/m2/s)") 

displot31 <- displot31 + geom_point(data = velocities, aes(Distance, y= jul31V), color = "tomato", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 13.3)) + geom_point(data = velocity, aes(distance, y= velocity), color = "blue", size = 3)
...
displot25 <- ggplot(c)+ 
 ...
 geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="purple") +   
  ...
  geom_point(aes(x= Distance, y= AverageFlux), color = "purple", size = 3) +   labs(x = "Synoptic Site Distance from Wetland (m) (7-25-3029)", y = "Average FLux (μmol/CO2/m2/s)") 

displot25 <- displot25 +  geom_point(data = velocities, aes(Distance, y= jul25V), color = "tomato", size = 2)  + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 13.5)) +geom_point(data = velocity, aes(distance, velocity), color = "blue", size = 3)
displot25
...
displot18 <- ggplot(c) + geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="purple") +   

  geom_point(aes(x= Distance, y= AverageFlux), color = "purple", size = 3) +   labs(x = "Synoptic Site Distance from Wetland (m) (7-18-3029)", y = "Average FLux (μmol/CO2/m2/s)") 

displot18 <- displot18 + geom_point(data = velocities, aes(Distance, y= jul18V), color = "tomato", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 12)) + geom_point(data = velocity, aes(distance, y= velocity), color = "blue", size = 3)
...
Velocit of each synoptic section
