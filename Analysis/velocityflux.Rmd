...
displot25 <- ggplot(c)+ 
 ...
 geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="purple") +   
  ...
  geom_point(aes(x= Distance, y= AverageFlux), color = "purple", size = 2) +   labs(x = "Synoptic Site Distance from Wetland (m) (7-25-3029)", y = "Average FLux (μmol/CO2/m2/s)") 

displot25 <- displot25 +  geom_point(data = velocity, aes(distance, y= velocity), color = "tomato", size = 3)  + scale_y_continuous(sec.axis = sec_axis( ~ . * 2.5 , name = "Velocity (m/s)"), limits = c(0, 26))
displot25
...
displot18 <- displot18 +  geom_point(data = velocity, aes(distance, y= velocity), color = "tomato", size = 3)  + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 22))
displot18
``` 
