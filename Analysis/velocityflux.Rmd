...
displot12 <- displot12 + geom_point(data = velocities, aes(Distance, y= aug12V), color = "steelblue2", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 12)) + geom_point(data = velocity, aes(distance, y= velocity), color = "blue", size = 3)
...
displot6 <- displot6 + geom_point(data = velocities, aes(Distance, y= aug6V), color = "steelblue2", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 11)) + geom_point(data = velocity, aes(distance, y= velocity), color = "blue", size = 3)
...
displot31 <- displot31 + geom_point(data = velocities, aes(Distance, y= jul31V), color = "steelblue2", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 14)) + geom_point(data = velocity, aes(x= distance, y= velocity), color = "blue", size = 3)
...
displot25 <- displot25 +  geom_point(data = velocities, aes(Distance, y= jul25V), color = "steelblue2", size = 2)  + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 13.5)) +geom_point(data = velocity, aes(distance, velocity), color = "blue", size = 3)
displot25
...
displot18 <- displot18 + geom_point(data = velocities, aes(Distance, y= jul18V), color = "steelblue2", size = 2) + scale_y_continuous(sec.axis = sec_axis( ~ . * 2 , name = "Velocity (m/s)"), limits = c(0, 12)) + geom_point(data = velocity, aes(distance, y= velocity), color = "blue", size = 3)
