...
# Quadratic Model
#df$stn3_Q <- predict(quadratic.model,list(x=df$lvl_421_m, x2=df$lvl_421_m^2))*1000
```
...
# Quadratic Model
df$stn4_Q <- predict(quadratic.model,list(x=df$lvl_421_m, x2=df$lvl_421_m^2))*1000
```
