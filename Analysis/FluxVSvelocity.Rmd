...
velocity vs flux 8-12-2019

```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}

vf <- cbind(c, velocity)
vf12 <- ggplot() + geom_point(data = vf, aes(velocity, y= AverageFlux), color = "steelblue3", size =3) 
vf12
...
``` 
velocity vs flux 8-6-2019

```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}

vf <- cbind(c, velocity)
vf6 <- ggplot() + geom_point(data = vf, aes(velocity, y= AverageFlux), color = "steelblue3", size =3) 
vf6
...
velocity vs flux 7-31-2019

```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}

vf <- cbind(c, velocity)
vf31 <- ggplot() + geom_point(data = vf, aes(velocity, y= AverageFlux), color = "steelblue3", size =3) 
vf31
...
velocity vs flux 7-25-2019

```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}

vf <- cbind(c, velocity)
vf25 <- ggplot() + geom_point(data = vf, aes(velocity, y= AverageFlux), color = "steelblue3", size =3) 
vf25
...
velocity vs flux 7-18-2019

```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}

vf <- cbind(c, velocity)
vf18 <- ggplot() + geom_point(data = vf, aes(velocity, y= AverageFlux), color = "steelblue3", size =3) 
vf18
