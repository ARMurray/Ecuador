...
displot12 <- ggplot(c)+ 
 ...
 geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="#009e73") +   
  ...
  geom_point(aes(x= Distance, y= AverageFlux), color = "#009e73", size = 3) + labs(x = "Synoptic Site Distance from Wetland (m) (8-12-2019)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']')))
...
labs(x = "Synoptic Site Distance from Wetland (m) (8-06-2019)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']')))
avgplot

combined1 <- displot12 + 
  geom_point(data = c, aes(x= Distance, y= AverageFlux), color = "#d55e00", size = 3) +
   geom_errorbar(data = c, aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="#d55e00") +   labs(x = "Synoptic Site Distance from Wetland (m)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']')))
...
displot31 <- ggplot(c) +
 ...
 geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="blue") +   
  ...
  geom_point(aes(x= Distance, y= AverageFlux), color = "blue", size = 3) + labs(x = "Synoptic Site Distance from Wetland (07-31-2019) (m)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']')))
...
combined2 <- combined1 + 
 ...
 geom_errorbar(data = c, aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="blue") +   
  ...
  geom_point(data = c, aes(x= Distance, y= AverageFlux), color = "blue", size = 3) + labs(x = "Synoptic Site Distance from Wetland (m)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']')))
...
displot25 <- ggplot(c)+ 
 ...
 geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="#56B4E9") +   
  ...
  geom_point(aes(x= Distance, y= AverageFlux), color = "#56B4E9", size = 3) +   labs(x = "Synoptic Site Distance from Wetland (m) (7-25-3029)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']'))) 
...
combined3 <- combined2 + 
 ...
 geom_errorbar(data = c, aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="#56B4E9") +   
  ...
  geom_point(data = c, aes(x= Distance, y= AverageFlux), color = "#56B4E9", size = 3) + labs(x = "Synoptic Site Distance from Wetland (m)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']')))
...
displot18 <- ggplot(c)+ 
 ...
 geom_errorbar(aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="#cc79a7") +   
  ...
  geom_point(aes(x= Distance, y= AverageFlux), color = "#cc79a7", size = 3) +   labs(x = "Synoptic Site Distance from Wetland (m) (7-18-3029)", y= expression(bold(Flux~('umol'/~m^2~s))) )
...
combined4 <- combined3 + 
 ...
 geom_errorbar(data = c, aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="#cc79a7") +   
  ...
  geom_point(data = c, aes(x= Distance, y= AverageFlux), color = "#cc79a7", size = 3) + labs(x = "Synoptic Site Distance from Wetland (m)", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']'))) + theme_bw(base_size = 18)

combined4 <- combined4 +   
labs(x = "Distance from Wetland [m]", y=expression(bold(CO["2"]~Evasion~'[umol'/~m^2~s~']'))) +
  theme_bw() +
