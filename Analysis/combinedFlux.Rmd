...
Average Flux of Each Site 8-12-2019
...
Average Flux of Each Site 8-6-2019
```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}
...
Average Flux of Each Site 7-25-2019
...
Average Flux of Each Site 7-18-2019
...
Average Flux of Each Site on all synoptic days
...
Synoptic Flux measurements compared to CO2 ppm of stream

```{r , eval=TRUE, warning=FALSE, echo=FALSE, fig.width = 12}

v <- read.csv(here("FieldData/Vaisala/Synoptics2.csv"))

ppmplot <- ggplot(v) + geom_point(aes(x= Distance, y= Syn1_071819), color = "purple", size = 2) +
...
plotz <- ggarrange(ppmplot, combined4)
plotz
