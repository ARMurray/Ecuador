---
title: "Flux at Collar Transects, not done"
author: "Chloe"
date: "Data from 7/22/2019 measurements"
output: html_document
---
wrong data, set to data from the 22nd
...
col3 <- sub.2[1748:1752,]
col4 <- sub.2[1743:1746,]
col5 <- sub.2[1711:1714,]
col6 <- sub.2[1716:1719,]
col7 <- sub.2[1726:1729,]
col8 <- sub.2[1732:1735,]
```
