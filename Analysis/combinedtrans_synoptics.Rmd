...
combined4 <- combined3 + 
 ...
 geom_errorbar(data = c, aes(x= Distance,y= AverageFlux, ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="purple") +   
  ...
  geom_point(data = c, aes(x= Distance, y= AverageFlux), color = "purple", size = 2) + labs(x = "Synoptic Site Distance from Wetland (m)", y = "Average FLux (μmol/CO2/m2/s)") + theme_bw()
...
allplotz <- avgplot1 +  geom_errorbar(data = a, aes(x= 1:8,ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), width=0.2, size=1, color="green") +
  geom_point(data = a, aes(x= 1:8, y= AverageFlux), color = "green", size = 2)+ theme_bw()
...
landwater <- ggplot() + geom_line(data = land, aes(x= DateTime, y= Flux_eos2), color = "green", size = 1) +
  geom_line(data = water, aes(x=DateTime, y= Flux_eos1), color = "blue", size = 1) + labs(x = "Date",y = "Average FLux (μmol/CO2/m2/s)")+ theme_bw()
...
nightplot<- ggplot() + geom_line(data = col1night, aes(x= DateTime, y= Flux_eos2), color = "red", size = 1) +
  geom_line(data = eos1night, aes(x=DateTime, y= Flux_eos1), color = "blue", size = 1) + labs(x = "Date", y = "Average FLux (μmol/CO2/m2/s)")+ theme_bw()
nightplot 
...
wetplot <- ggplot() + geom_line(data = wetlnd, aes(x= DateTime, y= Flux_eos2), color = "purple", size = 1) +
  geom_line(data = eos1same, aes(x=DateTime, y= Flux_eos1), color = "blue", size = 1) + labs(x = "Date", y = "Average FLux (μmol/CO2/m2/s)") + theme_bw()
wetplot
...
tplot <- allplotz + geom_errorbar(data = a, aes(x= 1:4,ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), 
                                  width=0.2, size=1, color="brown") +
  geom_point(data = a, aes(x= 1:4, y= AverageFlux), color = "brown", size = 2) +
  scale_x_continuous(breaks=1:4, labels=c("col1", "col2", "col3", "col4"))+ 
  labs(x = "Collar", y = "Average FLux (μmol/CO2/m2/s)")

ttplot <- allplotz + geom_errorbar(data = a, aes(x= 5:8,ymin= AverageFlux - StdDev, ymax= AverageFlux + StdDev), 
                                   width=0.2, size=1, color="brown") +
  geom_point(data = a, aes(x= 5:8, y= AverageFlux), color = "brown", size = 2) +
  scale_x_continuous(breaks=1:4, labels=c("col5", "col6", "col7","col8"))+ 
  labs(x = "Collar", y = "Average FLux (μmol/CO2/m2/s)")
